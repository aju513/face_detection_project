...
@section('content')
    ...
    <body>
        <div class="flex min-h-screen items-center justify-center bg-gradient-to-r p-4"
            style="background-image: url('{{ asset('img/bg-register.png') }}'); background-repeat: no-repeat; background-size: cover;">
            ...
            <div
                ...
                <div class="w-full md:w-1/2 p-6 md:p-10 items-center gap-2">
                    <div class="flex flex-col items-center gap-2">
                        ...
                        <div class="mb-6">
                            <p class=" text-xl">COL Architecture</p>
                        </div>
                    </div>
                    <form class="flex flex-col gap-10 justify-center" method="POST"
                        method="{{ route('website.update.password') }}">
                        @csrf
