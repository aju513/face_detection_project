        ...
        <div class="header-content">
            ...
            <div class="responsive-logo">
                <a class="responsive-logo-dark" href="" aria-label="Brand"><img
                        src="{{ asset('img/col-h.png') }}" alt="logo" class="mx-auto"></a>
                <a class="responsive-logo-light" href="" aria-label="Brand"><img
                        src="{{ asset('img/col-hw.png') }}" alt="logo" class="mx-auto"></a>
            </div>
                                    ...
                                    <div class="py-2 first:pt-0 last:pb-0" id="allNotifyContainer">
                                        <div class="ti-dropdown-item relative header-box">
                                            ...
                                            <a aria-label="anchor" href="javascript:void(0);"
                                                class="header-remove-btn ms-auto text-lg text-gray-500/20 dark:text-white/20 hover:text-gray-800 dark:hover:text-white">
                        ...
                        <div class="header-profile hs-dropdown ti-dropdown"
                            ...
                            <button id="dropdown-profile" type="button"
                                ...
                                <img class="inline-block rounded-full ring-2 ring-white dark:ring-white/10"
                                    src="{{ asset('img/col.png') }}" alt="Image Description">
                            </button>
