...
<div class="grid grid-cols-2 gap-5">
    ...
    <!-- Title Field -->
    <div class="mb-4.5 w-full">
        {{ html()->label('Details (*)')->for('title')->class('mb-2.5 block text-black dark:text-white') }}
        {{ html()->text('details')->placeholder('Details')->required()->class('ti-form-select' . ($errors->has('details') ? ' is-invalid' : '')) }}
        @include('admin.layouts.components.validation', ['name' => 'details'])
    </div>
