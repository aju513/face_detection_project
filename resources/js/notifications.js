(function () {
	...
	document.querySelector('#popup').addEventListener('click', function () {
		notifier.modal(`<h3 class="font-semibold mb-1 text-xl">Welcome To Tailwind Admin Template </h3>
		<small class="text-gray-500 dark:text-white/70 text-sm">Click outside the modal window to close it.</small>`, 'demo')
	})
